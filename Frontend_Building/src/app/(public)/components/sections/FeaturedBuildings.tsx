...
export function FeaturedBuildings() {
  ...
  return (
    <section className="container mx-auto px-4 py-12">
      <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Tòa nhà nổi bật</h2>
      ...
      <div className="text-center mt-8">
        <Link href="/buildings" className="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition shadow-md">
          Xem tất cả
        </Link>
      </div>
    </section>
